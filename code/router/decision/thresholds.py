"""Named threshold and weight constants used by decision fusion.

Action, borderline-risk, and content-urgency calibration is recorded in
SPEC.md ADR-009. Confidence-formula weights are recorded in the resolved
SPEC.md ADR-004.
"""
...
action is "notify". ADR-009 records the sample-message calibration that raised
this from 0.62 after engagement alone promoted routine messages to notify."""

T_DIGEST: float = 0.35
"""Fused priority score at/above which action is "digest" (below this,
"mute"). Calibrated against dataset/sample_messages.csv; see SPEC.md ADR-009."""
...
dataset/sample_messages.csv; see SPEC.md ADR-009."""
...
"""Weight of safety-gate certainty in the confidence formula. Resolved in
SPEC.md ADR-004."""
