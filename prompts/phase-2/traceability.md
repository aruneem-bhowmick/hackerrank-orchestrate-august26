...
| REQ-P2-04 | `REQ-P2-04-media-failure-fallback.md` | `code/router/ingestion/pipeline.py`, `code/router/ingestion/ocr.py`, `code/router/ingestion/asr.py` | `tests/unit/test_media_failure_fallback.py`, `tests/integration/test_media_failure_fallback_integration.py`, `tests/fixtures/ingestion_media_failures.py` |
